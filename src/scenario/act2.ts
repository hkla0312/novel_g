...
export const act2Nodes: ScenarioNode[] = [
  ...
  },
  {
    id: 'home_act2', title: '自宅再探索', location: 'home', text: [
      ...
      { label: '古いヘッドセットを手に取る', next: 'old_room_headset_memory', timeCost: 10, condition: { type: 'all', conditions: [{ type: 'knowledge', key: 'akano_yume_document' }, { type: 'collectionCount', collection: 'selfMemory', atLeast: 2 }, { type: 'flag', key: 'old_room_paper_memory_done' }, notFlag('mina_unlocked')] } },
  ...
  },
  {
    ...
    ], choices: [{ label: '戻る', next: 'home_act2' }], effects: [
